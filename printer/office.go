...
import (
	...
	"github.com/linyuanbin/fmt-conv/xcontext"
	"github.com/linyuanbin/fmt-conv/xerror"
	"github.com/linyuanbin/fmt-conv/xexec"
	"github.com/linyuanbin/fmt-conv/xlog"
	"github.com/linyuanbin/fmt-conv/xrand"
	"os"
	"path/filepath"
	"sort"
	"strings"
...
func (p officePrinter) Print(destination string) error {
	...
	defer cancel()
	resolver := func() error {
		// see https://github.com/loloxiaoz/fmt-conv/issues/139.
